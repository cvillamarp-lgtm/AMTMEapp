...
const aiProviderSchema = z.enum(['grok', 'gemini', 'claude', 'groq']);
...
export const metricMonthlySchema = z
  .object({
    id: z.string(),
    month: z.string(),
    platform: z.string(),
...
export const metricEpisodeSchema = z
  .object({
    id: z.string(),
    episodeId: z.string(),
...
export const monetizationLeadSchema = z
  .object({
    id: z.string(),
    source: z.string(),
    name: z.string(),
