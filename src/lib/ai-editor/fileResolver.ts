...
const ROUTE_FILE_MAP: Record<string, string[]> = {
  '/dashboard': ['src/app/(studio)/dashboard/page.tsx'],
  '/ia': ['src/app/(studio)/ia/page.tsx'],
  '/ia/editor': ['src/app/(studio)/ia/editor/page.tsx'],
  '/episodios': ['src/app/(studio)/episodios/page.tsx'],
  '/creador-visual': ['src/app/(studio)/creador-visual/page.tsx'],
  '/contenido': ['src/app/(studio)/contenido/page.tsx'],
  '/calendario': ['src/app/(studio)/calendario/page.tsx'],
  '/metricas': ['src/app/(studio)/metricas/page.tsx'],
  '/metricas/spotify': ['src/app/(studio)/metricas/spotify/page.tsx'],
  '/monetizacion': ['src/app/(studio)/monetizacion/page.tsx'],
  '/automatizacion': ['src/app/(studio)/automatizacion/page.tsx'],
  '/configuracion': ['src/app/(studio)/configuracion/page.tsx'],
  '/verificador': ['src/app/(studio)/verificador/page.tsx'],
  '/historico': ['src/app/(studio)/historico/page.tsx'],
  '/checklists': ['src/app/(studio)/checklists/page.tsx'],
  '/politica-operativa': ['src/app/(studio)/politica-operativa/page.tsx'],
  '/documento-maestro': ['src/app/(studio)/documento-maestro/page.tsx'],
  '/estrategia': ['src/app/(studio)/estrategia/page.tsx'],
  '/guiones': ['src/app/(studio)/guiones/page.tsx'],
  '/ideas': ['src/app/(studio)/ideas/page.tsx'],
  '/instagram': ['src/app/(studio)/instagram/page.tsx'],
  '/notas': ['src/app/(studio)/notas/page.tsx'],
  '/revision-episodios': ['src/app/(studio)/revision-episodios/page.tsx'],
};
