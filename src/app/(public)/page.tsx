...
async function getRecentEpisodes() {
  try {
    ...
    if (!sb) return []
    const { data } = await sb.from('episodes').select('payload').is('user_id', null).order('created_at', { ascending: false }).limit(3)
...
>>>>>>> f04b222 (feat: revision-episodios+checklists+notas Supabase, metricas reportes IA, seeds maestro 25 secciones, 16 checklists)
      <nav className="flex items-center justify-between px-6 py-4 border-b border-white/10">
        ...
        <Link href="/auth/sign-in" className="text-sm text-[#9DC4D5] hover:text-white transition-colors">
          Acceso estudio →
        </Link>
      </nav>
...
<<<<<<< HEAD
      <section className="max-w-3xl mx-auto px-6 py-20 text-center">
        <p className="text-[#e8ff40] text-sm font-semibold uppercase tracking-widest mb-4">Podcast en español</p>
        <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
          A Mí También<br />Me Explicaron
=======
      {/* HERO */}
      <section className="max-w-3xl mx-auto px-6 py-20 text-center">
        <p className="text-[#e8ff40] text-sm font-semibold uppercase tracking-widest mb-4">Podcast en español</p>
...
<<<<<<< HEAD
          <a href="https://open.spotify.com/show/amtme" target="_blank" rel="noopener noreferrer"
...
=======
      ...
      {episodes.length > 0 && (
        <section className="max-w-3xl mx-auto px-6 pb-16">
          <h2 className="text-sm font-semibold text-[#9DC4D5] uppercase tracking-widest mb-6">Episodios recientes</h2>
          <div className="space-y-4">
            {episodes.map((ep: any, i: number) => (
              <div key={i} className="border border-white/10 rounded-2xl p-5 hover:border-[#e8ff40]/40 transition-colors">
                <div className="flex items-start gap-4">
                  <span className="text-[#e8ff40] font-bold text-sm mt-0.5">#{ep.episode_number || i + 1}</span>
                  <div>
...
>>>>>>> f04b222 (feat: revision-episodios+checklists+notas Supabase, metricas reportes IA, seeds maestro 25 secciones, 16 checklists)
      <section id="lecturas" className="bg-white/5 border-t border-white/10">
        <div className="max-w-3xl mx-auto px-6 py-16 text-center">
          <p className="text-[#e8ff40] text-sm font-semibold uppercase tracking-widest mb-4">Lecturas simbólicas</p>
...
<<<<<<< HEAD
          ...
          <a href="https://instagram.com/yosoyvillamar" target="_blank" rel="noopener noreferrer"
...
<<<<<<< HEAD
      <footer className="border-t border-white/10 px-6 py-8 text-center text-[#9DC4D5] text-sm">
        <p>© 2026 A Mí También Me Explicaron · <a href="https://instagram.com/amtmepodcast" target="_blank" className="hover:text-white">@amtmepodcast</a></p>
=======
      {/* CAPTURA DE LEADS */}
      <section className="max-w-3xl mx-auto px-6 py-16">
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-3">Suscríbete al boletín</h2>
          <p className="text-[#9DC4D5] mb-6">Reflexiones breves sobre amor e identidad. Sin spam. Sin ruido.</p>
          <form
      ...
      {/* FOOTER */}
      <footer className="border-t border-white/10 px-6 py-8 text-center text-[#9DC4D5] text-sm">
        <p>© 2026 A Mí Tampoco Me Explicaron · <a href="https://instagram.com/amtmepodcast" target="_blank" className="hover:text-white">@amtmepodcast</a></p>
>>>>>>> f04b222 (feat: revision-episodios+checklists+notas Supabase, metricas reportes IA, seeds maestro 25 secciones, 16 checklists)
      </footer>
    </div>
  )
