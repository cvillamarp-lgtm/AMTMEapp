...
import { PageHeader, LoadingSkeleton, EmptyState, StatusBadge } from '@/components/ui';
  ...
  return (
    <div className="space-y-6 pb-10">
      <PageHeader
        eyebrow="Producción"
        title="Episodios"
        description="Ciclo completo de producción desde idea hasta medición"
      />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, publish_date: e.target.value || null })}
              />
            </div>
            <DialogFooter>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Comienza tu ciclo de producción creando el primer episodio"
          action={{ label: 'Crear primer episodio', onClick: () => setDialogOpen(true) }}
        />
      ) : (
