...
export default function VerificadorPage() {
  ...
  return (
    <div className="space-y-5 pb-24">
      <Card className="bg-amtme-navy text-white">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <Card className="bg-amtme-cream">
          <div className="text-xs uppercase tracking-[0.2em] text-black/40">Checks</div>
          <div className="mt-3 text-3xl font-semibold tracking-tight text-amtme-navy">
        ...
        <Card className="bg-amtme-cream">
          ...
          <div className="mt-3 text-3xl font-semibold tracking-tight text-amtme-red">
            {highCount}
          </div>
      ...
      <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="mt-4 space-y-3">
            {summary.issues.length === 0 ? (
              ...
              summary.issues.map((issue) => (
                <div
                  key={issue.id}
                  className="rounded-3xl border border-black/8 bg-amtme-cream p-4"
                >
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <h3 className="text-base font-semibold text-amtme-navy">{issue.title}</h3>
                  ...
                  <p className="mt-2 text-sm leading-6 text-amtme-navy">Acción: {issue.action}</p>
                </div>
              ))
            )}
          </div>
        ...
        <Card>
          ...
          <pre className="mt-4 max-h-[560px] overflow-auto rounded-3xl border border-black/8 bg-amtme-cream p-4 text-xs leading-6 text-amtme-navy">
            {report}
          </pre>
