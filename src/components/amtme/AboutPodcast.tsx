      ...
      <div className="mx-auto grid max-w-[1320px] grid-cols-1 gap-16 lg:grid-cols-12">
        <div className="lg:col-span-4">
          ...
          <h2 className="mt-5 font-display text-4xl text-navy lg:text-5xl">
            Una casa<br />para los que<br />sintieron<br />
        ...
        <div className="space-y-6 text-lg leading-relaxed text-navy/80 lg:col-span-7 lg:col-start-6">
          <p>
            ...
            demasiado, han esperado demasiado y un día necesitan volver a escucharse.
          </p>
          <p className="text-navy/65">
            No viene a darte respuestas perfectas. Viene a acompañarte mientras
            encuentras las tuyas. Aquí no hablamos desde el pedestal — hablamos desde
            el camino, con honestidad, vulnerabilidad y una mirada simbólica que usa el
            tarot como espejo de conciencia.
          </p>
          <p className="text-navy/65">
          ...
          <div className="pt-4">
            <a href="#episodios" className="group inline-flex items-center gap-2 text-sm font-semibold text-navy">
