import { BRAND } from '@/lib/editorial/constants';
import { SectionLabel } from './icons';

const backImg = '/amtme-editorial/christian-back.jpg';
      ...
      <div className="mx-auto grid max-w-[1320px] grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
        ...
        <div className="order-1 lg:order-2 lg:col-span-7">
          ...
          <div className="mt-8 space-y-5 text-lg leading-relaxed text-navy/75">
            <p>
              Soy {BRAND.host}. AMTME nace de todo eso que también tuve que aprender tarde: amar sin
              desaparecer, soltar sin romperme y volver a mí sin pedir permiso.
            </p>
